...
import com.ydniu.mvpbase.net.RetryWithDelay;
        ...
        return new ObservableTransformer<T, T>() {
            @Override public ObservableSource<T> apply(@NonNull Observable<T> upstream) {
                return upstream
                        ...
                        .compose(RxSchedulersUtils.<T>bindToLifecycle(provider));
        ...
        return new ObservableTransformer<T, T>() {
            @Override public ObservableSource<T> apply(@NonNull Observable<T> upstream) {
                return upstream
                        ...
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .compose(RxSchedulersUtils.<T>bindToLifecycle(provider, event));
